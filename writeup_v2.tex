...
decoding, not an isolated benchmark-accuracy claim.
\end{abstract}
...
The motivation for v2 is twofold. First, the original M.I.N.D. pipeline showed
that a calibrated classical decoder with selective prediction is a testable
assistive-control framing. Second, current EEG decoding studies commonly
compare against compact deep architectures. M.I.N.D. v2 therefore adds EEGNet
and a spatial-attention backbone, while keeping the primary research question
focused on reliability under realistic cross-session shift.
...
paper artifacts are written under
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{public_artifacts/v2_paper_artifacts/figures/figure_1_headline_performance_BCI_IV_2a.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.72\linewidth]{public_artifacts/v2_paper_artifacts/figures/figure_2_risk_coverage_BCI_IV_2a.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.72\linewidth]{public_artifacts/v2_paper_artifacts/figures/figure_3_reliability_support_BCI_IV_2a.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.86\linewidth]{public_artifacts/v2_paper_artifacts/figures/figure_4_subject_deltas_BCI_IV_2a.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.72\linewidth]{public_artifacts/v2_paper_artifacts/figures/figure_5_coverage_sweep_BCI_IV_2a.pdf}
...
requires tighter threshold calibration and external domain review.
